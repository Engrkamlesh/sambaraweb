...
const Home = () => {
  return (
    <div className="w-full bg-image h-auto px-6 md:px-8 lg:px-20 xl:px-28 py-12">
      <div className="grid lg:grid-cols-2 gap-10 items-center pt-24">
        ...
        <div className="flex flex-col">
          ...
          {/* Heading 2 */}
          <h2 className="text-4xl sm:text-2xl md:text-4xl font-bold  text-white text-left">
            Shaping the Future of Real Estate with Powerful App{" "}
          </h2>

          {/* Paragraph */}
          <p className="text-left text-white mt-4 text-sm sm:text-base leading-relaxed">
