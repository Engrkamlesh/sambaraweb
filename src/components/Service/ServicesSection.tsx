...
const ServicesCards: React.FC = () => {
  return (
    <>
      <div className="flex justify-center items-center bg-gray-100 py-10 mt-4">
      ...
      <div className="flex justify-center items-center bg-gradient-to-b from-gray-100 to-gray-200 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 px-6">
          ...
          <div className="mb-4 flex justify-center">
            ...
            <p className="text-gray-700 text-sm text-center">
            Transforming ideas into intuitive and visually appealing digital experiences. 
            Crafting user-centered designs that drive engagement and functionality.
            </p>
          </div>
        </div>
      </div>
