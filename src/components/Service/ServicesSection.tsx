      ...
      <div className="flex justify-center items-center bg-gradient-to-b from-gray-100 to-gray-200 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 px-6">
          ...
          <div className="bg-white border border-gray-300 shadow-lg hover:shadow-2xl rounded-lg p-6 w-56 mx-auto transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-gray-700 text-sm text-center">
              Android app development ensures a robust and versatile application
              that meets diverse business needs across the Google Play
              ecosystem.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-300 shadow-lg hover:shadow-2xl rounded-lg p-6 w-56 mx-auto transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-gray-700 text-sm text-center">
              Transforming ideas into intuitive and visually appealing digital
              experiences. Crafting user-centered designs that drive engagement
              and functionality.
            </p>
          </div>
        </div>
